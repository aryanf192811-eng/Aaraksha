...
type EnumGroup = 'sosCategory' | 'travelType' | 'zoneType' | 'tsiLabel' | 'tripStatus' | 'scamCategory' | 'crowdLevel' | 'feltSafe' | 'activityType' | 'packingCategory' | 'difficulty' | 'connectivity' | 'incidentCategory' | 'incidentStatus'
