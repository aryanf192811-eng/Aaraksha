...
export const SOCKET_EVENTS = {
  ...
  // One simulated NTN (satellite) uplink attempt completed, delivered or
  // not — live telemetry tick for the NTN network panel (see migration
  // 024_ntn_messages / ntn.service.js).
