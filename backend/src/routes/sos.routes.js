...
const { CreateSOSSchema, AmendCategorySchema } = require('../validators/sos.validator')
...
router.patch('/:id/amend-category', validate(AmendCategorySchema), ctrl.amendCategory)
