...
// Matches local_operators.category exactly (migration 027) — the Local
// Tourism Enablement pillar's provider taxonomy. EXPERIENCE displays as
// "Local Experience" in the UI; the enum value itself stays short.
const LOCAL_OPERATOR_CATEGORIES = Object.freeze({
  HOTEL: 'HOTEL',
  HOMESTAY: 'HOMESTAY',
  GUIDE: 'GUIDE',
...
module.exports = {
  ...
  NTN_SCENARIOS, LOCAL_OPERATOR_CATEGORIES,
}
